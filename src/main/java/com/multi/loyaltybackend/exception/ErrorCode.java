...
public enum ErrorCode {
    ...
    INVALID_VERIFICATION_CODE("INVALID_VERIFICATION_CODE", "Invalid email verification code"),
    VERIFICATION_CODE_EXPIRED("VERIFICATION_CODE_EXPIRED", "Email verification code has expired"),
